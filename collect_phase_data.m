...
function [deltaPhi,Scapk,SmoothPhase,clkbias_u,clkbias_r] = collect_phase_data(gps_sat,gps_time,visible_sats_id,ref_station_ecef,ref_station,true_user_pos_geodetic,true_user_pos_ecef,initial_user_pos_estimate,ibeacon1_geo,ibeacon1_ecef,ibeacon2_geo,ibeacon2_ecef,initial_bias_u,initial_bias_r)
...
clkbias_u = rcvr_clk_model(initial_bias_u,randn);

clkbias_r = rcvr_clk_model(initial_bias_r,randn);
